...
* For information about encrypting your Portworx volumes using Kubernetes secrets, refer to the [Using Kubernetes Secrets with Portworx](/operations/key-management/kubernetes-secrets/) section.
